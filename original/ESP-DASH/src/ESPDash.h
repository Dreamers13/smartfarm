...
{
    private:
        CardData card_storage[MAX_CARD_NUMBER];
        ChartData chart_values_storage[MAX_VALUES];

        Vector<CardData> cData;
        Vector<ChartData> chartData;
    ...
    public:
        ...
        int AddCard(const int type, const char *name, int min = 0, int max = 100, int datatype = 0);
        int AddCard(const int type, const char *name, const char *y_axis_name, int datatype = 0);
        ...
        void UpdateCard(const int cardID, float value, String &valueS);
        void UpdateCard(const int cardID, String &value);
        void UpdateCard(int cardID, void (*funptr)(CardData *));
